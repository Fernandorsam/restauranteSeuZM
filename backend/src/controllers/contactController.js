...
import { createContact, getContacts, getContactById, deleteContact, markContactAsRead }
 from '../services/contactService.js';
import { created, paginated, notFound, success } from '../utils/ApiResponse.js';
...
class ContactController {
  ...
  create = asyncHandler(async (req, res) => {
    ...
    return created(res, 'Mensagem enviada com sucesso! Entraremos em contato em breve.', {
      contact
    });
  });
