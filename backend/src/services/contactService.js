...
import { create, find, countDocuments, findById, findByIdAndUpdate, findByIdAndDelete } from '../models/Contact.js';
import { notifyAdminNewContact } from './notificationService.js';
...
class ContactService {
  ...
  async markContactAsRead(id) {
    const contact = await findByIdAndUpdate(
      id,
      {
        status: 'read',
        readAt: new Date()
  ...
  async deleteContact(id) {
    const contact = await findByIdAndDelete(id);
