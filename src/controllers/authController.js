...
class AuthController {
 ...
 console.log('req.body:>>>>>', req.body);
  ...
  refreshToken = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'Token renovado com sucesso', { token });
  });
  ...
  verifyEmail = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'E-mail verificado com sucesso');
  });
  ...
  resendVerification = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'E-mail de verificação reenviado');
  });
  ...
  forgotPassword = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'Se o e-mail existir, um link de reset foi enviado');
  });
  ...
  resetPassword = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'Senha alterada com sucesso');
  });
  ...
  getMe = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'Perfil obtido', { user: user.toPublicProfile() });
  });
  ...
  updateProfile = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'Perfil atualizado', { user: user.toPublicProfile() });
  });
  ...
  deleteMyAccount = asyncHandler(async (req, res) => {
    ...
    res.clearCookie('refreshToken');
    return ApiResponse.success(res, 'Conta desativada com sucesso');
  });
  ...
  getAllUsers = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.paginated(res, 'Usuários listados', result);
  });
  ...
  getUserById = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'Usuário encontrado', { user: user.toPublicProfile() });
  });
  ...
  updateUser = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'Usuário atualizado', { user: user.toPublicProfile() });
  });
  ...
  deleteUser = asyncHandler(async (req, res) => {
    ...
    return ApiResponse.success(res, 'Usuário removido');
  });
  ...
  changeUserRole = asyncHandler(async (req, res) => {
    const user = await authService.changeUserRole(req.params.id, req.body.role, req.body.permissions);
    return ApiResponse.success(res, 'Papel do usuário atualizado', { user: user.toPublicProfile() });
  });
}
